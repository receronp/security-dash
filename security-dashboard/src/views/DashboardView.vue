...
export default {
  ...
  methods: {
    ...
    show2() {
      document.getElementById("change").innerHTML =
        "<iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7194.825532780457!2d-100.28332257733926!3d25.624422708460273!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8662bf70f8e81e1f%3A0xf9786ba6532f8041!2sLas%20Brisas%2C%2064780%20Monterrey%2C%20N.L.!5e0!3m2!1ses-419!2smx!4v1655089701046!5m2!1ses-419!2smx' width='650' height='460' style='border:0;' allowfullscreen='' loading='lazy' referrerpolicy='no-referrer-when-downgrade'></iframe>";
      const element = document.getElementById("commute");
    ...
    show3() {
      document.getElementById("change").innerHTML =
        "<iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7190.686876038726!2d-100.26019007733339!3d25.69305065277062!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8662eab23819bc63%3A0xba8787a24b4ef726!2sLinda%20Vista%2C%2067130%20Guadalupe%2C%20N.L.!5e0!3m2!1ses-419!2smx!4v1655089767064!5m2!1ses-419!2smx' width='650' height='460' style='border:0;' allowfullscreen='' loading='lazy' referrerpolicy='no-referrer-when-downgrade'></iframe>";
      const element = document.getElementById("commute");
  ...
  async mounted() {
    var data = null;
    const result = await CallApi(urlBase + "/vehicle", "GET", data);
    if (result.length > 0) {
